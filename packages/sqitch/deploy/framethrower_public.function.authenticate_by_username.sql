-- Deploy flipr:framethrower_public.function.authenticate_by_username to pg

begin;
  create or replace function framethrower_public.authenticate_by_username(
    username text,
    password text
  ...
  grant execute on function framethrower_public.authenticate_by_username(text, text) to framethrower_anonymous;
commit;
