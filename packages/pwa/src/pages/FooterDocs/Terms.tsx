...
const Terms = () => {
  return (
    <Pagelayout>
      ...
      <h4 className='text-white text-opacity-50 ml-12'>
        Last Updated 21 July 2020
      </h4>
      <h3 className='ml-4 mt-4'>1. Agreement to Terms</h3>
      <p className='my-4 mx-8'>
        ...
        and Framethrower, located at 2615 Columbia Street, Vancouver, British
        Columbia V5Y2G3 Canada (we, us), concerning your access to and use of
        the Framethrower (http://framethrower.io) website as well as any related
        applications (the Site).
      </p>
      <p className='my-4 mx-8'>
        The Site provides the following services: Online animation community
        that offers professional feedback to animation uploaded by community
        members. (Services). You agree that by accessing the Site and/or
      ...
      <p className='my-4 mx-8'>
        1.6 Additional policies which also apply to your use of the Site
        include:
      </p>
      <ul className='ml-12'>
        <li className='p-1'>
          Our Privacy Notice Footer: Privacy Policy, which sets out the terms on
          which we process any personal data we collect from you, or that you
          provide to us. By using the Site, you consent to such processing and
          you warrant that all data provided by you is accurate.
        </li>
        <li className='p-1'>
          Our Acceptable Use Policy About: User conduct, which sets out the
          permitted uses and prohibited uses of the Site. When using the Site,
          you must comply with this Acceptable Use Policy.{' '}
        </li>
        <li className='p-1'>
          If you purchase services from the Site, our terms and conditions of
          supply Terms and Conditions of Supply: Pro Feedback will apply to the
          use.{' '}
        </li>
        <li className='p-1'>
          ...
          Terms and Conditions of Supply: Pro Feedback.
        </li>
      </ul>
      <h3 className='ml-4 mt-4'>2. Acceptable Use</h3>
      <p className='my-4 mx-8'>
        2.1 Our full Acceptable Use Policy About: User conduct, sets out all the
      ...
      <p className='my-4 mx-8'>2.3 As a user of this Site, you agree not to:</p>
      <ul className='ml-12'>
        <li className='p-1'>
        ...
        <li className='p-1'>Sell or otherwise transfer your profile</li>
        <li className='p-1'>
      ...
      <h3 className='ml-4 mt-4'>3. Information you provide to us</h3>
      <p className='my-4 mx-8'>
      ...
      <p className='my-4 mx-8'>
        ...
        password you must promptly notify us at support@framethrower.io.
      </p>
      <p className='my-4 mx-8'>
      ...
      <p className='my-4 mx-8'>
        ...
        Site. At your email request to support@framethrower.io or through your
        account settings (if applicable), we will deactivate the connection
        between the Site and your Third Party Account and attempt to delete any
        information stored on our servers that was obtained through such Third
        Party Account, except the username and profile picture that became
        associated with your account.
      </p>
      <h3 className='ml-4 mt-4'>4. Content you provide to us</h3>
      <p className='my-4 mx-8'>
      ...
      <p className='my-4 mx-8'>
        ...
        please contact us at support@framethrower.io or use the take down or
        report button.
      </p>
      <h3 className='ml-4 mt-4'>5. Our content </h3>
      <p className='my-4 mx-8'>
      ...
      <h3 className='ml-4 mt-4'>6. Link to third party content</h3>
      <p className='my-4 mx-8'>
      ...
      <h3 className='ml-4 mt-4'>7. Site Management </h3>
      <p className='my-4 mx-8'>
        ...
        Conditions; (3) refuse, restrict access to or availability of, or
        disable (to the extent technologically feasible) any of your
        Contributions; (4) remove from the Site or otherwise disable all files
        and content that are excessive in size or are in any way a burden to our
      ...
      <h3 className='ml-4 mt-4'>9. Disclaimer/Limitation of Liability</h3>
      <p className='my-4 mx-8'>
      ...
      <ul className='ml-12'>
        ...
        <li className='p-1'>
          ...
          of (a) the sum of £50$ or (b) the amount paid, if any, by you to us
          for the Services/Site during the six (6) month period prior to any
          cause of action arising. Different limitations and exclusions of
          ...
          of supply Terms and Conditions of Supply: Pro Feedback.
        </li>
      </ul>
      <h3 className='ml-4 mt-4'>10. Term and Termination</h3>
      ...
      <h3 className='ml-4 mt-4'>11. General</h3>
      <p className='my-4 mx-8'>
      ...
      <p className='my-4 mx-8'>
        11.8 A person who is not a party to these Terms and Conditions shall
        have no right under the Contracts (Rights of Third Parties) Act 1999 to
        enforce any term of these Terms and Conditions.
      </p>
      <p className='my-4 mx-8'>
        11.9 In order to resolve a complaint regarding the Services or to
        receive further information regarding use of the Services, please
        contact us by email at support@framethrower.io.
      </p>
      {/* <p className='my-4 mx-8'>
        Framethrower
        <br /> 2615 Columbia Street
