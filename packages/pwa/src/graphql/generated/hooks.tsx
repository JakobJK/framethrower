...
export const AdminChangeInstructorStatusDocument = gql`
...
`
export type AdminChangeInstructorStatusMutationFn = Apollo.MutationFunction<
  AdminChangeInstructorStatusMutation,
  AdminChangeInstructorStatusMutationVariables
>

/**
 * __useAdminChangeInstructorStatusMutation__
 *
 * To run a mutation, you first call `useAdminChangeInstructorStatusMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAdminChangeInstructorStatusMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [adminChangeInstructorStatusMutation, { data, loading, error }] = useAdminChangeInstructorStatusMutation({
 *   variables: {
 *      profileId: // value for 'profileId'
 *      instructorStatus: // value for 'instructorStatus'
 *   },
 * });
 */
export function useAdminChangeInstructorStatusMutation(
  ...
  return Apollo.useMutation<
    AdminChangeInstructorStatusMutation,
    AdminChangeInstructorStatusMutationVariables
  >(AdminChangeInstructorStatusDocument, baseOptions)
}
export type AdminChangeInstructorStatusMutationHookResult = ReturnType<
  typeof useAdminChangeInstructorStatusMutation
>
export type AdminChangeInstructorStatusMutationResult = Apollo.MutationResult<
  AdminChangeInstructorStatusMutation
>
export type AdminChangeInstructorStatusMutationOptions = Apollo.BaseMutationOptions<
  AdminChangeInstructorStatusMutation,
  AdminChangeInstructorStatusMutationVariables
>
export const AdminPromoteToInstructorDocument = gql`
  mutation adminPromoteToInstructor($profileId: UUID!) {
...
`
export type AdminPromoteToInstructorMutationFn = Apollo.MutationFunction<
  AdminPromoteToInstructorMutation,
  AdminPromoteToInstructorMutationVariables
>

/**
 * __useAdminPromoteToInstructorMutation__
 *
 * To run a mutation, you first call `useAdminPromoteToInstructorMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAdminPromoteToInstructorMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [adminPromoteToInstructorMutation, { data, loading, error }] = useAdminPromoteToInstructorMutation({
 *   variables: {
 *      profileId: // value for 'profileId'
 *   },
 * });
 */
export function useAdminPromoteToInstructorMutation(
  baseOptions?: Apollo.MutationHookOptions<
    AdminPromoteToInstructorMutation,
    AdminPromoteToInstructorMutationVariables
  >
  ...
  return Apollo.useMutation<
    AdminPromoteToInstructorMutation,
    AdminPromoteToInstructorMutationVariables
  >(AdminPromoteToInstructorDocument, baseOptions)
}
export type AdminPromoteToInstructorMutationHookResult = ReturnType<
  typeof useAdminPromoteToInstructorMutation
>
export type AdminPromoteToInstructorMutationResult = Apollo.MutationResult<
  AdminPromoteToInstructorMutation
>
export type AdminPromoteToInstructorMutationOptions = Apollo.BaseMutationOptions<
  AdminPromoteToInstructorMutation,
  AdminPromoteToInstructorMutationVariables
>
export const AdminUpdatePostDocument = gql`
  mutation adminUpdatePost($title: String!, $id: UUID!, $body: String!) {
...
`
export type AdminUpdatePostMutationFn = Apollo.MutationFunction<
  AdminUpdatePostMutation,
  AdminUpdatePostMutationVariables
>
...
export function useAdminUpdatePostMutation(
  ...
  return Apollo.useMutation<
    AdminUpdatePostMutation,
    AdminUpdatePostMutationVariables
  >(AdminUpdatePostDocument, baseOptions)
}
export type AdminUpdatePostMutationHookResult = ReturnType<
  typeof useAdminUpdatePostMutation
>
export type AdminUpdatePostMutationResult = Apollo.MutationResult<
  AdminUpdatePostMutation
>
export type AdminUpdatePostMutationOptions = Apollo.BaseMutationOptions<
  AdminUpdatePostMutation,
  AdminUpdatePostMutationVariables
>
export const AllCompanyAdminMonthsDocument = gql`
  query allCompanyAdminMonths($groupId: UUID!) {
    allVCompanyAdminMonths(filter: { groupId: { equalTo: $groupId } }) {
      nodes {
        year
        id
        month
...
/**
 * __useAllCompanyAdminMonthsQuery__
 *
 * To run a query within a React component, call `useAllCompanyAdminMonthsQuery` and pass it any options that fit your needs.
 * When your component renders, `useAllCompanyAdminMonthsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAllCompanyAdminMonthsQuery({
 *   variables: {
 *      groupId: // value for 'groupId'
 *   },
 * });
 */
export function useAllCompanyAdminMonthsQuery(
  baseOptions: Apollo.QueryHookOptions<
    AllCompanyAdminMonthsQuery,
    AllCompanyAdminMonthsQueryVariables
  >
) {
  return Apollo.useQuery<
    AllCompanyAdminMonthsQuery,
    AllCompanyAdminMonthsQueryVariables
  >(AllCompanyAdminMonthsDocument, baseOptions)
}
export function useAllCompanyAdminMonthsLazyQuery(
...
export type AllCompanyAdminMonthsQueryHookResult = ReturnType<
  typeof useAllCompanyAdminMonthsQuery
>
export type AllCompanyAdminMonthsLazyQueryHookResult = ReturnType<
  typeof useAllCompanyAdminMonthsLazyQuery
>
export type AllCompanyAdminMonthsQueryResult = Apollo.QueryResult<
  AllCompanyAdminMonthsQuery,
  AllCompanyAdminMonthsQueryVariables
>
 ...
 *      repeatedNewPassword: // value for 'repeatedNewPassword'
 *   },
 * });
 */
...
export const ChangeUserRoleDocument = gql`
  mutation changeUserRole($userId: UUID!, $role: UserRole!) {
...
>
export type ChangeUserRoleMutationResult = Apollo.MutationResult<
  ChangeUserRoleMutation
>
export type ChangeUserRoleMutationOptions = Apollo.BaseMutationOptions<
  ...
  ChangeUserRoleMutationVariables
>
export const ClaimFeedbackDocument = gql`
...
`
export type ClaimFeedbackMutationFn = Apollo.MutationFunction<
  ClaimFeedbackMutation,
  ClaimFeedbackMutationVariables
>

/**
 * __useClaimFeedbackMutation__
 *
 * To run a mutation, you first call `useClaimFeedbackMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useClaimFeedbackMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [claimFeedbackMutation, { data, loading, error }] = useClaimFeedbackMutation({
 *   variables: {
 *      feedbackRequestId: // value for 'feedbackRequestId'
 *      submissionId: // value for 'submissionId'
 *   },
 * });
 */
export function useClaimFeedbackMutation(
  baseOptions?: Apollo.MutationHookOptions<
    ClaimFeedbackMutation,
    ClaimFeedbackMutationVariables
  >
  ...
  return Apollo.useMutation<
    ClaimFeedbackMutation,
    ClaimFeedbackMutationVariables
  >(ClaimFeedbackDocument, baseOptions)
}
export type ClaimFeedbackMutationHookResult = ReturnType<
  typeof useClaimFeedbackMutation
>
export type ClaimFeedbackMutationResult = Apollo.MutationResult<
  ClaimFeedbackMutation
>
export type ClaimFeedbackMutationOptions = Apollo.BaseMutationOptions<
  ClaimFeedbackMutation,
  ClaimFeedbackMutationVariables
>
export const CompanyAdminAddMonthToGroupDocument = gql`
  mutation companyAdminAddMonthToGroup(
    $year: Int!
    $month: Int!
    $groupId: UUID!
    $amountFeedbacks: Int!
...
`
export type CompanyAdminAddMonthToGroupMutationFn = Apollo.MutationFunction<
  CompanyAdminAddMonthToGroupMutation,
  CompanyAdminAddMonthToGroupMutationVariables
>

/**
 * __useCompanyAdminAddMonthToGroupMutation__
 *
 * To run a mutation, you first call `useCompanyAdminAddMonthToGroupMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCompanyAdminAddMonthToGroupMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [companyAdminAddMonthToGroupMutation, { data, loading, error }] = useCompanyAdminAddMonthToGroupMutation({
 *   variables: {
 *      year: // value for 'year'
 *      month: // value for 'month'
 *      groupId: // value for 'groupId'
 *      amountFeedbacks: // value for 'amountFeedbacks'
 *   },
 * });
 */
export function useCompanyAdminAddMonthToGroupMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CompanyAdminAddMonthToGroupMutation,
    CompanyAdminAddMonthToGroupMutationVariables
  >
  ...
  return Apollo.useMutation<
    CompanyAdminAddMonthToGroupMutation,
    CompanyAdminAddMonthToGroupMutationVariables
  >(CompanyAdminAddMonthToGroupDocument, baseOptions)
}
export type CompanyAdminAddMonthToGroupMutationHookResult = ReturnType<
  typeof useCompanyAdminAddMonthToGroupMutation
>
export type CompanyAdminAddMonthToGroupMutationResult = Apollo.MutationResult<
  CompanyAdminAddMonthToGroupMutation
>
export type CompanyAdminAddMonthToGroupMutationOptions = Apollo.BaseMutationOptions<
  CompanyAdminAddMonthToGroupMutation,
  CompanyAdminAddMonthToGroupMutationVariables
>
export const CompanyAdminAddPremiumToGroupDocument = gql`
  mutation companyAdminAddPremiumToGroup($groupId: UUID!, $premiumId: UUID!) {
...
`
export type CompanyAdminAddPremiumToGroupMutationFn = Apollo.MutationFunction<
  CompanyAdminAddPremiumToGroupMutation,
  CompanyAdminAddPremiumToGroupMutationVariables
>

/**
 * __useCompanyAdminAddPremiumToGroupMutation__
 *
 * To run a mutation, you first call `useCompanyAdminAddPremiumToGroupMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCompanyAdminAddPremiumToGroupMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [companyAdminAddPremiumToGroupMutation, { data, loading, error }] = useCompanyAdminAddPremiumToGroupMutation({
 *   variables: {
 *      groupId: // value for 'groupId'
 *      premiumId: // value for 'premiumId'
 *   },
 * });
 */
export function useCompanyAdminAddPremiumToGroupMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CompanyAdminAddPremiumToGroupMutation,
    CompanyAdminAddPremiumToGroupMutationVariables
  >
  ...
  return Apollo.useMutation<
    CompanyAdminAddPremiumToGroupMutation,
    CompanyAdminAddPremiumToGroupMutationVariables
  >(CompanyAdminAddPremiumToGroupDocument, baseOptions)
}
export type CompanyAdminAddPremiumToGroupMutationHookResult = ReturnType<
  typeof useCompanyAdminAddPremiumToGroupMutation
>
export type CompanyAdminAddPremiumToGroupMutationResult = Apollo.MutationResult<
  CompanyAdminAddPremiumToGroupMutation
>
export type CompanyAdminAddPremiumToGroupMutationOptions = Apollo.BaseMutationOptions<
  CompanyAdminAddPremiumToGroupMutation,
  CompanyAdminAddPremiumToGroupMutationVariables
>
export const CompanyAdminRemoveMonthFromGroupDocument = gql`
  mutation companyAdminRemoveMonthFromGroup($monthId: UUID!) {
...
`
export type CompanyAdminRemoveMonthFromGroupMutationFn = Apollo.MutationFunction<
  CompanyAdminRemoveMonthFromGroupMutation,
  CompanyAdminRemoveMonthFromGroupMutationVariables
>

/**
 * __useCompanyAdminRemoveMonthFromGroupMutation__
 *
 * To run a mutation, you first call `useCompanyAdminRemoveMonthFromGroupMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCompanyAdminRemoveMonthFromGroupMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [companyAdminRemoveMonthFromGroupMutation, { data, loading, error }] = useCompanyAdminRemoveMonthFromGroupMutation({
 *   variables: {
 *      monthId: // value for 'monthId'
 *   },
 * });
 */
export function useCompanyAdminRemoveMonthFromGroupMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CompanyAdminRemoveMonthFromGroupMutation,
    CompanyAdminRemoveMonthFromGroupMutationVariables
  >
  ...
  return Apollo.useMutation<
    CompanyAdminRemoveMonthFromGroupMutation,
    CompanyAdminRemoveMonthFromGroupMutationVariables
  >(CompanyAdminRemoveMonthFromGroupDocument, baseOptions)
}
export type CompanyAdminRemoveMonthFromGroupMutationHookResult = ReturnType<
  typeof useCompanyAdminRemoveMonthFromGroupMutation
>
export type CompanyAdminRemoveMonthFromGroupMutationResult = Apollo.MutationResult<
  CompanyAdminRemoveMonthFromGroupMutation
>
export type CompanyAdminRemoveMonthFromGroupMutationOptions = Apollo.BaseMutationOptions<
  CompanyAdminRemoveMonthFromGroupMutation,
  CompanyAdminRemoveMonthFromGroupMutationVariables
>
export const CompanyAdminRemovePremiumFromGroupDocument = gql`
  mutation companyAdminRemovePremiumFromGroup($premiumId: UUID!) {
...
`
export type CompanyAdminRemovePremiumFromGroupMutationFn = Apollo.MutationFunction<
  CompanyAdminRemovePremiumFromGroupMutation,
  CompanyAdminRemovePremiumFromGroupMutationVariables
>

/**
 * __useCompanyAdminRemovePremiumFromGroupMutation__
 *
 * To run a mutation, you first call `useCompanyAdminRemovePremiumFromGroupMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCompanyAdminRemovePremiumFromGroupMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [companyAdminRemovePremiumFromGroupMutation, { data, loading, error }] = useCompanyAdminRemovePremiumFromGroupMutation({
 *   variables: {
 *      premiumId: // value for 'premiumId'
 *   },
 * });
 */
export function useCompanyAdminRemovePremiumFromGroupMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CompanyAdminRemovePremiumFromGroupMutation,
    CompanyAdminRemovePremiumFromGroupMutationVariables
  >
  ...
  return Apollo.useMutation<
    CompanyAdminRemovePremiumFromGroupMutation,
    CompanyAdminRemovePremiumFromGroupMutationVariables
  >(CompanyAdminRemovePremiumFromGroupDocument, baseOptions)
}
export type CompanyAdminRemovePremiumFromGroupMutationHookResult = ReturnType<
  typeof useCompanyAdminRemovePremiumFromGroupMutation
>
export type CompanyAdminRemovePremiumFromGroupMutationResult = Apollo.MutationResult<
  CompanyAdminRemovePremiumFromGroupMutation
>
export type CompanyAdminRemovePremiumFromGroupMutationOptions = Apollo.BaseMutationOptions<
  CompanyAdminRemovePremiumFromGroupMutation,
  CompanyAdminRemovePremiumFromGroupMutationVariables
>
export const CompanyCreateGroupDocument = gql`
  mutation companyCreateGroup($name: String!, $description: String) {
...
`
export type CompanyCreateGroupMutationFn = Apollo.MutationFunction<
  CompanyCreateGroupMutation,
  CompanyCreateGroupMutationVariables
>

/**
 * __useCompanyCreateGroupMutation__
 *
 * To run a mutation, you first call `useCompanyCreateGroupMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCompanyCreateGroupMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [companyCreateGroupMutation, { data, loading, error }] = useCompanyCreateGroupMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCompanyCreateGroupMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CompanyCreateGroupMutation,
    CompanyCreateGroupMutationVariables
  >
  ...
  return Apollo.useMutation<
    CompanyCreateGroupMutation,
    CompanyCreateGroupMutationVariables
  >(CompanyCreateGroupDocument, baseOptions)
}
export type CompanyCreateGroupMutationHookResult = ReturnType<
  typeof useCompanyCreateGroupMutation
>
export type CompanyCreateGroupMutationResult = Apollo.MutationResult<
  CompanyCreateGroupMutation
>
export type CompanyCreateGroupMutationOptions = Apollo.BaseMutationOptions<
  CompanyCreateGroupMutation,
  CompanyCreateGroupMutationVariables
>
export const CompanyDeleteGroupDocument = gql`
  mutation companyDeleteGroup($id: UUID!) {
...
`
export type CompanyDeleteGroupMutationFn = Apollo.MutationFunction<
  CompanyDeleteGroupMutation,
  CompanyDeleteGroupMutationVariables
>

/**
 * __useCompanyDeleteGroupMutation__
 *
 * To run a mutation, you first call `useCompanyDeleteGroupMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCompanyDeleteGroupMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [companyDeleteGroupMutation, { data, loading, error }] = useCompanyDeleteGroupMutation({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useCompanyDeleteGroupMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CompanyDeleteGroupMutation,
    CompanyDeleteGroupMutationVariables
  >
  ...
  return Apollo.useMutation<
    CompanyDeleteGroupMutation,
    CompanyDeleteGroupMutationVariables
  >(CompanyDeleteGroupDocument, baseOptions)
}
export type CompanyDeleteGroupMutationHookResult = ReturnType<
  typeof useCompanyDeleteGroupMutation
>
export type CompanyDeleteGroupMutationResult = Apollo.MutationResult<
  CompanyDeleteGroupMutation
>
export type CompanyDeleteGroupMutationOptions = Apollo.BaseMutationOptions<
  CompanyDeleteGroupMutation,
  CompanyDeleteGroupMutationVariables
>
export const DeleteOwnAnimationDocument = gql`
  mutation deleteOwnAnimation($animationId: String!) {
    deleteOwnAnimation(input: { animationId: $animationId }) {
      string
    }
  }
`
export type DeleteOwnAnimationMutationFn = Apollo.MutationFunction<
  DeleteOwnAnimationMutation,
  DeleteOwnAnimationMutationVariables
>

/**
 * __useDeleteOwnAnimationMutation__
 *
 * To run a mutation, you first call `useDeleteOwnAnimationMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteOwnAnimationMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [deleteOwnAnimationMutation, { data, loading, error }] = useDeleteOwnAnimationMutation({
 *   variables: {
 *      animationId: // value for 'animationId'
 *   },
 * });
 */
export function useDeleteOwnAnimationMutation(
  baseOptions?: Apollo.MutationHookOptions<
    DeleteOwnAnimationMutation,
    DeleteOwnAnimationMutationVariables
  >
  ...
  return Apollo.useMutation<
    DeleteOwnAnimationMutation,
    DeleteOwnAnimationMutationVariables
  >(DeleteOwnAnimationDocument, baseOptions)
}
export type DeleteOwnAnimationMutationHookResult = ReturnType<
  typeof useDeleteOwnAnimationMutation
>
export type DeleteOwnAnimationMutationResult = Apollo.MutationResult<
  DeleteOwnAnimationMutation
>
export type DeleteOwnAnimationMutationOptions = Apollo.BaseMutationOptions<
  DeleteOwnAnimationMutation,
  DeleteOwnAnimationMutationVariables
>
export const DeleteOwnNoteDocument = gql`
  mutation deleteOwnNote($id: String!) {
...
`
export type DeleteOwnNoteMutationFn = Apollo.MutationFunction<
  DeleteOwnNoteMutation,
  DeleteOwnNoteMutationVariables
>

/**
 * __useDeleteOwnNoteMutation__
 *
 * To run a mutation, you first call `useDeleteOwnNoteMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteOwnNoteMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [deleteOwnNoteMutation, { data, loading, error }] = useDeleteOwnNoteMutation({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useDeleteOwnNoteMutation(
  baseOptions?: Apollo.MutationHookOptions<
    DeleteOwnNoteMutation,
    DeleteOwnNoteMutationVariables
  >
  ...
  return Apollo.useMutation<
    DeleteOwnNoteMutation,
    DeleteOwnNoteMutationVariables
  >(DeleteOwnNoteDocument, baseOptions)
}
export type DeleteOwnNoteMutationHookResult = ReturnType<
  typeof useDeleteOwnNoteMutation
>
export type DeleteOwnNoteMutationResult = Apollo.MutationResult<
  DeleteOwnNoteMutation
>
export type DeleteOwnNoteMutationOptions = Apollo.BaseMutationOptions<
  DeleteOwnNoteMutation,
  DeleteOwnNoteMutationVariables
>
export const DeleteNoteCommentDocument = gql`
  mutation deleteNoteComment($id: UUID!) {
...
`
export type DeleteNoteCommentMutationFn = Apollo.MutationFunction<
  DeleteNoteCommentMutation,
  DeleteNoteCommentMutationVariables
>

/**
 * __useDeleteNoteCommentMutation__
 *
 * To run a mutation, you first call `useDeleteNoteCommentMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteNoteCommentMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [deleteNoteCommentMutation, { data, loading, error }] = useDeleteNoteCommentMutation({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useDeleteNoteCommentMutation(
  baseOptions?: Apollo.MutationHookOptions<
    DeleteNoteCommentMutation,
    DeleteNoteCommentMutationVariables
  >
  ...
  return Apollo.useMutation<
    DeleteNoteCommentMutation,
    DeleteNoteCommentMutationVariables
  >(DeleteNoteCommentDocument, baseOptions)
}
export type DeleteNoteCommentMutationHookResult = ReturnType<
  typeof useDeleteNoteCommentMutation
>
export type DeleteNoteCommentMutationResult = Apollo.MutationResult<
  DeleteNoteCommentMutation
>
export type DeleteNoteCommentMutationOptions = Apollo.BaseMutationOptions<
  DeleteNoteCommentMutation,
  DeleteNoteCommentMutationVariables
>
export const DeleteOwnSubmissionDocument = gql`
  mutation deleteOwnSubmission($submissionId: String!) {
    deleteOwnSubmission(input: { submissionId: $submissionId }) {
      string
    }
  }
`
export type DeleteOwnSubmissionMutationFn = Apollo.MutationFunction<
  DeleteOwnSubmissionMutation,
  DeleteOwnSubmissionMutationVariables
>

/**
 * __useDeleteOwnSubmissionMutation__
 *
 * To run a mutation, you first call `useDeleteOwnSubmissionMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteOwnSubmissionMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [deleteOwnSubmissionMutation, { data, loading, error }] = useDeleteOwnSubmissionMutation({
 *   variables: {
 *      submissionId: // value for 'submissionId'
 *   },
 * });
 */
export function useDeleteOwnSubmissionMutation(
  baseOptions?: Apollo.MutationHookOptions<
    DeleteOwnSubmissionMutation,
    DeleteOwnSubmissionMutationVariables
  >
  ...
  return Apollo.useMutation<
    DeleteOwnSubmissionMutation,
    DeleteOwnSubmissionMutationVariables
  >(DeleteOwnSubmissionDocument, baseOptions)
}
export type DeleteOwnSubmissionMutationHookResult = ReturnType<
  typeof useDeleteOwnSubmissionMutation
>
export type DeleteOwnSubmissionMutationResult = Apollo.MutationResult<
  DeleteOwnSubmissionMutation
>
export type DeleteOwnSubmissionMutationOptions = Apollo.BaseMutationOptions<
  DeleteOwnSubmissionMutation,
  DeleteOwnSubmissionMutationVariables
>
export const InstructorRegisterBannerDocument = gql`
  mutation instructorRegisterBanner($banner: String!) {
...
`
export type InstructorRegisterBannerMutationFn = Apollo.MutationFunction<
  InstructorRegisterBannerMutation,
  InstructorRegisterBannerMutationVariables
>

/**
 * __useInstructorRegisterBannerMutation__
 *
 * To run a mutation, you first call `useInstructorRegisterBannerMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useInstructorRegisterBannerMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [instructorRegisterBannerMutation, { data, loading, error }] = useInstructorRegisterBannerMutation({
 *   variables: {
 *      banner: // value for 'banner'
 *   },
 * });
 */
export function useInstructorRegisterBannerMutation(
  baseOptions?: Apollo.MutationHookOptions<
    InstructorRegisterBannerMutation,
    InstructorRegisterBannerMutationVariables
  >
  ...
  return Apollo.useMutation<
    InstructorRegisterBannerMutation,
    InstructorRegisterBannerMutationVariables
  >(InstructorRegisterBannerDocument, baseOptions)
}
export type InstructorRegisterBannerMutationHookResult = ReturnType<
  typeof useInstructorRegisterBannerMutation
>
export type InstructorRegisterBannerMutationResult = Apollo.MutationResult<
  InstructorRegisterBannerMutation
>
export type InstructorRegisterBannerMutationOptions = Apollo.BaseMutationOptions<
  InstructorRegisterBannerMutation,
  InstructorRegisterBannerMutationVariables
>
export const InstructorUpdateAvailabilityDocument = gql`
  mutation instructorUpdateAvailability(
    $availability: InstructorAvailability!
  ) {
...
`
export type InstructorUpdateAvailabilityMutationFn = Apollo.MutationFunction<
  InstructorUpdateAvailabilityMutation,
  InstructorUpdateAvailabilityMutationVariables
>

/**
 * __useInstructorUpdateAvailabilityMutation__
 *
 * To run a mutation, you first call `useInstructorUpdateAvailabilityMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useInstructorUpdateAvailabilityMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [instructorUpdateAvailabilityMutation, { data, loading, error }] = useInstructorUpdateAvailabilityMutation({
 *   variables: {
 *      availability: // value for 'availability'
 *   },
 * });
 */
export function useInstructorUpdateAvailabilityMutation(
  baseOptions?: Apollo.MutationHookOptions<
    InstructorUpdateAvailabilityMutation,
    InstructorUpdateAvailabilityMutationVariables
  >
  ...
  return Apollo.useMutation<
    InstructorUpdateAvailabilityMutation,
    InstructorUpdateAvailabilityMutationVariables
  >(InstructorUpdateAvailabilityDocument, baseOptions)
}
export type InstructorUpdateAvailabilityMutationHookResult = ReturnType<
  typeof useInstructorUpdateAvailabilityMutation
>
export type InstructorUpdateAvailabilityMutationResult = Apollo.MutationResult<
  InstructorUpdateAvailabilityMutation
>
export type InstructorUpdateAvailabilityMutationOptions = Apollo.BaseMutationOptions<
  InstructorUpdateAvailabilityMutation,
  InstructorUpdateAvailabilityMutationVariables
>
export const InstructorUpdateBioDocument = gql`
  mutation instructorUpdateBio($bio: String!) {
...
`
export type InstructorUpdateBioMutationFn = Apollo.MutationFunction<
  InstructorUpdateBioMutation,
  InstructorUpdateBioMutationVariables
>

/**
 * __useInstructorUpdateBioMutation__
 *
 * To run a mutation, you first call `useInstructorUpdateBioMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useInstructorUpdateBioMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [instructorUpdateBioMutation, { data, loading, error }] = useInstructorUpdateBioMutation({
 *   variables: {
 *      bio: // value for 'bio'
 *   },
 * });
 */
export function useInstructorUpdateBioMutation(
  baseOptions?: Apollo.MutationHookOptions<
    InstructorUpdateBioMutation,
    InstructorUpdateBioMutationVariables
  >
  ...
  return Apollo.useMutation<
    InstructorUpdateBioMutation,
    InstructorUpdateBioMutationVariables
  >(InstructorUpdateBioDocument, baseOptions)
}
export type InstructorUpdateBioMutationHookResult = ReturnType<
  typeof useInstructorUpdateBioMutation
>
export type InstructorUpdateBioMutationResult = Apollo.MutationResult<
  InstructorUpdateBioMutation
>
export type InstructorUpdateBioMutationOptions = Apollo.BaseMutationOptions<
  InstructorUpdateBioMutation,
  InstructorUpdateBioMutationVariables
>
...
export function useLoginByEmailMutation(
  ...
  return Apollo.useMutation<
    LoginByEmailMutation,
    LoginByEmailMutationVariables
  >(LoginByEmailDocument, baseOptions)
}
export type LoginByEmailMutationHookResult = ReturnType<
  typeof useLoginByEmailMutation
>
export type LoginByEmailMutationResult = Apollo.MutationResult<
  LoginByEmailMutation
>
...
`
export type LoginByUsernameMutationFn = Apollo.MutationFunction<
  LoginByUsernameMutation,
  LoginByUsernameMutationVariables
>

/**
 * __useLoginByUsernameMutation__
 *
 * To run a mutation, you first call `useLoginByUsernameMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useLoginByUsernameMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [loginByUsernameMutation, { data, loading, error }] = useLoginByUsernameMutation({
 *   variables: {
 ...
 * });
 */
export function useLoginByUsernameMutation(
  baseOptions?: Apollo.MutationHookOptions<
    LoginByUsernameMutation,
    LoginByUsernameMutationVariables
  >
  ...
  return Apollo.useMutation<
    LoginByUsernameMutation,
    LoginByUsernameMutationVariables
  >(LoginByUsernameDocument, baseOptions)
}
export type LoginByUsernameMutationHookResult = ReturnType<
  typeof useLoginByUsernameMutation
>
export type LoginByUsernameMutationResult = Apollo.MutationResult<
  LoginByUsernameMutation
>
export type LoginByUsernameMutationOptions = Apollo.BaseMutationOptions<
  LoginByUsernameMutation,
  LoginByUsernameMutationVariables
>
...
export type RefreshTokenMutationOptions = Apollo.BaseMutationOptions<
  ...
  RefreshTokenMutationVariables
>
export const RegisterAvatarDocument = gql`
  mutation registerAvatar($avatar: String!) {
...
`
export type RegisterAvatarMutationFn = Apollo.MutationFunction<
  RegisterAvatarMutation,
  RegisterAvatarMutationVariables
>

/**
 * __useRegisterAvatarMutation__
 *
 * To run a mutation, you first call `useRegisterAvatarMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRegisterAvatarMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [registerAvatarMutation, { data, loading, error }] = useRegisterAvatarMutation({
 *   variables: {
 *      avatar: // value for 'avatar'
 *   },
 * });
 */
export function useRegisterAvatarMutation(
  baseOptions?: Apollo.MutationHookOptions<
    RegisterAvatarMutation,
    RegisterAvatarMutationVariables
  >
  ...
  return Apollo.useMutation<
    RegisterAvatarMutation,
    RegisterAvatarMutationVariables
  >(RegisterAvatarDocument, baseOptions)
}
export type RegisterAvatarMutationHookResult = ReturnType<
  typeof useRegisterAvatarMutation
>
export type RegisterAvatarMutationResult = Apollo.MutationResult<
  RegisterAvatarMutation
>
export type RegisterAvatarMutationOptions = Apollo.BaseMutationOptions<
  RegisterAvatarMutation,
  RegisterAvatarMutationVariables
>
export const RegisterFeedbackResponseDocument = gql`
  mutation registerFeedbackResponse($thumbnail: String!, $link: String!) {
    __typename
...
`
export type RegisterFeedbackResponseMutationFn = Apollo.MutationFunction<
  RegisterFeedbackResponseMutation,
  RegisterFeedbackResponseMutationVariables
>

/**
 * __useRegisterFeedbackResponseMutation__
 *
 * To run a mutation, you first call `useRegisterFeedbackResponseMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRegisterFeedbackResponseMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [registerFeedbackResponseMutation, { data, loading, error }] = useRegisterFeedbackResponseMutation({
 *   variables: {
 ...
 * });
 */
export function useRegisterFeedbackResponseMutation(
  baseOptions?: Apollo.MutationHookOptions<
    RegisterFeedbackResponseMutation,
    RegisterFeedbackResponseMutationVariables
  >
  ...
  return Apollo.useMutation<
    RegisterFeedbackResponseMutation,
    RegisterFeedbackResponseMutationVariables
  >(RegisterFeedbackResponseDocument, baseOptions)
}
export type RegisterFeedbackResponseMutationHookResult = ReturnType<
  typeof useRegisterFeedbackResponseMutation
>
export type RegisterFeedbackResponseMutationResult = Apollo.MutationResult<
  RegisterFeedbackResponseMutation
>
export type RegisterFeedbackResponseMutationOptions = Apollo.BaseMutationOptions<
  RegisterFeedbackResponseMutation,
  RegisterFeedbackResponseMutationVariables
>
export const RegisterHeadlineDocument = gql`
  mutation registerHeadline(
    $thumbnail: String!
    $link: String!
    $title: String
  ) {
...
`
export type RegisterHeadlineMutationFn = Apollo.MutationFunction<
  RegisterHeadlineMutation,
  RegisterHeadlineMutationVariables
>

/**
 * __useRegisterHeadlineMutation__
 *
 * To run a mutation, you first call `useRegisterHeadlineMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRegisterHeadlineMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [registerHeadlineMutation, { data, loading, error }] = useRegisterHeadlineMutation({
 *   variables: {
 *      thumbnail: // value for 'thumbnail'
 *      link: // value for 'link'
 *      title: // value for 'title'
 ...
 * });
 */
export function useRegisterHeadlineMutation(
  baseOptions?: Apollo.MutationHookOptions<
    RegisterHeadlineMutation,
    RegisterHeadlineMutationVariables
  >
  ...
  return Apollo.useMutation<
    RegisterHeadlineMutation,
    RegisterHeadlineMutationVariables
  >(RegisterHeadlineDocument, baseOptions)
}
export type RegisterHeadlineMutationHookResult = ReturnType<
  typeof useRegisterHeadlineMutation
>
export type RegisterHeadlineMutationResult = Apollo.MutationResult<
  RegisterHeadlineMutation
>
export type RegisterHeadlineMutationOptions = Apollo.BaseMutationOptions<
  RegisterHeadlineMutation,
  RegisterHeadlineMutationVariables
>
export const RegisterNewBannerDocument = gql`
  mutation registerNewBanner($banner: String!) {
...
`
export type RegisterNewBannerMutationFn = Apollo.MutationFunction<
  RegisterNewBannerMutation,
  RegisterNewBannerMutationVariables
>

/**
 * __useRegisterNewBannerMutation__
 *
 * To run a mutation, you first call `useRegisterNewBannerMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRegisterNewBannerMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [registerNewBannerMutation, { data, loading, error }] = useRegisterNewBannerMutation({
 *   variables: {
 *      banner: // value for 'banner'
 *   },
 * });
 */
export function useRegisterNewBannerMutation(
  baseOptions?: Apollo.MutationHookOptions<
    RegisterNewBannerMutation,
    RegisterNewBannerMutationVariables
  >
  ...
  return Apollo.useMutation<
    RegisterNewBannerMutation,
    RegisterNewBannerMutationVariables
  >(RegisterNewBannerDocument, baseOptions)
}
export type RegisterNewBannerMutationHookResult = ReturnType<
  typeof useRegisterNewBannerMutation
>
export type RegisterNewBannerMutationResult = Apollo.MutationResult<
  RegisterNewBannerMutation
>
export type RegisterNewBannerMutationOptions = Apollo.BaseMutationOptions<
  RegisterNewBannerMutation,
  RegisterNewBannerMutationVariables
>
export const RegisterNewsDocument = gql`
...
`
export type RegisterNewsMutationFn = Apollo.MutationFunction<
  RegisterNewsMutation,
  RegisterNewsMutationVariables
>

/**
 * __useRegisterNewsMutation__
 *
 * To run a mutation, you first call `useRegisterNewsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRegisterNewsMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [registerNewsMutation, { data, loading, error }] = useRegisterNewsMutation({
 *   variables: {
 *      title: // value for 'title'
 *      paragraph: // value for 'paragraph'
 *      body: // value for 'body'
 *      thumbnail: // value for 'thumbnail'
 *      proContent: // value for 'proContent'
 *      videoUrl: // value for 'videoUrl'
 *   },
 * });
 */
export function useRegisterNewsMutation(
  baseOptions?: Apollo.MutationHookOptions<
    RegisterNewsMutation,
    RegisterNewsMutationVariables
  >
  ...
  return Apollo.useMutation<
    RegisterNewsMutation,
    RegisterNewsMutationVariables
  >(RegisterNewsDocument, baseOptions)
}
export type RegisterNewsMutationHookResult = ReturnType<
  typeof useRegisterNewsMutation
>
export type RegisterNewsMutationResult = Apollo.MutationResult<
  RegisterNewsMutation
>
export type RegisterNewsMutationOptions = Apollo.BaseMutationOptions<
  RegisterNewsMutation,
  RegisterNewsMutationVariables
>
export const RegisterNewsCommentDocument = gql`
  mutation registerNewsComment($body: String!, $newsId: UUID) {
...
`
export type RegisterNewsCommentMutationFn = Apollo.MutationFunction<
  RegisterNewsCommentMutation,
  RegisterNewsCommentMutationVariables
>

/**
 * __useRegisterNewsCommentMutation__
 *
 * To run a mutation, you first call `useRegisterNewsCommentMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRegisterNewsCommentMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [registerNewsCommentMutation, { data, loading, error }] = useRegisterNewsCommentMutation({
 *   variables: {
 *      body: // value for 'body'
 ...
 * });
 */
export function useRegisterNewsCommentMutation(
  baseOptions?: Apollo.MutationHookOptions<
    RegisterNewsCommentMutation,
    RegisterNewsCommentMutationVariables
  >
  ...
  return Apollo.useMutation<
    RegisterNewsCommentMutation,
    RegisterNewsCommentMutationVariables
  >(RegisterNewsCommentDocument, baseOptions)
}
export type RegisterNewsCommentMutationHookResult = ReturnType<
  typeof useRegisterNewsCommentMutation
>
export type RegisterNewsCommentMutationResult = Apollo.MutationResult<
  RegisterNewsCommentMutation
>
export type RegisterNewsCommentMutationOptions = Apollo.BaseMutationOptions<
  RegisterNewsCommentMutation,
  RegisterNewsCommentMutationVariables
>
export const RegisterNoteDocument = gql`
...
`
export type RegisterNoteMutationFn = Apollo.MutationFunction<
  RegisterNoteMutation,
  RegisterNoteMutationVariables
>

/**
 * __useRegisterNoteMutation__
 *
 * To run a mutation, you first call `useRegisterNoteMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRegisterNoteMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [registerNoteMutation, { data, loading, error }] = useRegisterNoteMutation({
 *   variables: {
 *      submissionId: // value for 'submissionId'
 *      body: // value for 'body'
 *      paragraph: // value for 'paragraph'
 ...
 * });
 */
export function useRegisterNoteMutation(
  baseOptions?: Apollo.MutationHookOptions<
    RegisterNoteMutation,
    RegisterNoteMutationVariables
  >
  ...
  return Apollo.useMutation<
    RegisterNoteMutation,
    RegisterNoteMutationVariables
  >(RegisterNoteDocument, baseOptions)
}
export type RegisterNoteMutationHookResult = ReturnType<
  typeof useRegisterNoteMutation
>
export type RegisterNoteMutationResult = Apollo.MutationResult<
  RegisterNoteMutation
>
export type RegisterNoteMutationOptions = Apollo.BaseMutationOptions<
  RegisterNoteMutation,
  RegisterNoteMutationVariables
>
export const RegisterNoteCommentDocument = gql`
  mutation registerNoteComment($noteId: String!, $body: String!) {
    __typename
...
`
export type RegisterNoteCommentMutationFn = Apollo.MutationFunction<
  RegisterNoteCommentMutation,
  RegisterNoteCommentMutationVariables
>

/**
 * __useRegisterNoteCommentMutation__
 *
 * To run a mutation, you first call `useRegisterNoteCommentMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRegisterNoteCommentMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [registerNoteCommentMutation, { data, loading, error }] = useRegisterNoteCommentMutation({
 *   variables: {
 ...
 * });
 */
export function useRegisterNoteCommentMutation(
  baseOptions?: Apollo.MutationHookOptions<
    RegisterNoteCommentMutation,
    RegisterNoteCommentMutationVariables
  >
  ...
  return Apollo.useMutation<
    RegisterNoteCommentMutation,
    RegisterNoteCommentMutationVariables
  >(RegisterNoteCommentDocument, baseOptions)
}
export type RegisterNoteCommentMutationHookResult = ReturnType<
  typeof useRegisterNoteCommentMutation
>
export type RegisterNoteCommentMutationResult = Apollo.MutationResult<
  RegisterNoteCommentMutation
>
export type RegisterNoteCommentMutationOptions = Apollo.BaseMutationOptions<
  RegisterNoteCommentMutation,
  RegisterNoteCommentMutationVariables
>
...
`
export type RegisterProfileMutationFn = Apollo.MutationFunction<
  RegisterProfileMutation,
  RegisterProfileMutationVariables
>
...
export function useRegisterProfileMutation(
  ...
  return Apollo.useMutation<
    RegisterProfileMutation,
    RegisterProfileMutationVariables
  >(RegisterProfileDocument, baseOptions)
}
export type RegisterProfileMutationHookResult = ReturnType<
  typeof useRegisterProfileMutation
>
export type RegisterProfileMutationResult = Apollo.MutationResult<
  RegisterProfileMutation
>
export type RegisterProfileMutationOptions = Apollo.BaseMutationOptions<
  RegisterProfileMutation,
  RegisterProfileMutationVariables
>
...
`
export type RegisterSocialMutationFn = Apollo.MutationFunction<
...
export function useRegisterSocialMutation(
  ...
  return Apollo.useMutation<
    RegisterSocialMutation,
    RegisterSocialMutationVariables
  >(RegisterSocialDocument, baseOptions)
}
export type RegisterSocialMutationHookResult = ReturnType<
  typeof useRegisterSocialMutation
>
export type RegisterSocialMutationResult = Apollo.MutationResult<
  RegisterSocialMutation
>
export type RegisterSocialMutationOptions = Apollo.BaseMutationOptions<
  RegisterSocialMutation,
  RegisterSocialMutationVariables
>
export const RegisterProfileDetailsDocument = gql`
...
`
export type RegisterProfileDetailsMutationFn = Apollo.MutationFunction<
  RegisterProfileDetailsMutation,
  RegisterProfileDetailsMutationVariables
>

/**
 * __useRegisterProfileDetailsMutation__
 *
 * To run a mutation, you first call `useRegisterProfileDetailsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRegisterProfileDetailsMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [registerProfileDetailsMutation, { data, loading, error }] = useRegisterProfileDetailsMutation({
 *   variables: {
 ...
 * });
 */
export function useRegisterProfileDetailsMutation(
  baseOptions?: Apollo.MutationHookOptions<
    RegisterProfileDetailsMutation,
    RegisterProfileDetailsMutationVariables
  >
  ...
  return Apollo.useMutation<
    RegisterProfileDetailsMutation,
    RegisterProfileDetailsMutationVariables
  >(RegisterProfileDetailsDocument, baseOptions)
}
export type RegisterProfileDetailsMutationHookResult = ReturnType<
  typeof useRegisterProfileDetailsMutation
>
export type RegisterProfileDetailsMutationResult = Apollo.MutationResult<
  RegisterProfileDetailsMutation
>
export type RegisterProfileDetailsMutationOptions = Apollo.BaseMutationOptions<
  RegisterProfileDetailsMutation,
  RegisterProfileDetailsMutationVariables
>
export const RequestProfeedbackDocument = gql`
  mutation requestProfeedback($animationId: String!) {
    requestProfeedback(input: { animationdId_: $animationId }) {
      boolean
    }
  }
`
export type RequestProfeedbackMutationFn = Apollo.MutationFunction<
  RequestProfeedbackMutation,
  RequestProfeedbackMutationVariables
>

/**
 * __useRequestProfeedbackMutation__
 *
 * To run a mutation, you first call `useRequestProfeedbackMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRequestProfeedbackMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [requestProfeedbackMutation, { data, loading, error }] = useRequestProfeedbackMutation({
 *   variables: {
 *      animationId: // value for 'animationId'
 *   },
 * });
 */
export function useRequestProfeedbackMutation(
  baseOptions?: Apollo.MutationHookOptions<
    RequestProfeedbackMutation,
    RequestProfeedbackMutationVariables
  >
  ...
  return Apollo.useMutation<
    RequestProfeedbackMutation,
    RequestProfeedbackMutationVariables
  >(RequestProfeedbackDocument, baseOptions)
}
export type RequestProfeedbackMutationHookResult = ReturnType<
  typeof useRequestProfeedbackMutation
>
export type RequestProfeedbackMutationResult = Apollo.MutationResult<
  RequestProfeedbackMutation
>
export type RequestProfeedbackMutationOptions = Apollo.BaseMutationOptions<
  RequestProfeedbackMutation,
  RequestProfeedbackMutationVariables
>
export const UpdateAnimationTitleDocument = gql`
  mutation updateAnimationTitle($animationId: String!, $title: String!) {
...
`
export type UpdateAnimationTitleMutationFn = Apollo.MutationFunction<
  UpdateAnimationTitleMutation,
  UpdateAnimationTitleMutationVariables
>

/**
 * __useUpdateAnimationTitleMutation__
 *
 * To run a mutation, you first call `useUpdateAnimationTitleMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateAnimationTitleMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateAnimationTitleMutation, { data, loading, error }] = useUpdateAnimationTitleMutation({
 *   variables: {
 *      animationId: // value for 'animationId'
 *      title: // value for 'title'
 *   },
 * });
 */
export function useUpdateAnimationTitleMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateAnimationTitleMutation,
    UpdateAnimationTitleMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateAnimationTitleMutation,
    UpdateAnimationTitleMutationVariables
  >(UpdateAnimationTitleDocument, baseOptions)
}
export type UpdateAnimationTitleMutationHookResult = ReturnType<
  typeof useUpdateAnimationTitleMutation
>
export type UpdateAnimationTitleMutationResult = Apollo.MutationResult<
  UpdateAnimationTitleMutation
>
export type UpdateAnimationTitleMutationOptions = Apollo.BaseMutationOptions<
  UpdateAnimationTitleMutation,
  UpdateAnimationTitleMutationVariables
>
export const UpdateOwnNewsCommentDocument = gql`
  mutation UpdateOwnNewsComment($id: UUID!, $body: String!) {
...
`
export type UpdateOwnNewsCommentMutationFn = Apollo.MutationFunction<
  UpdateOwnNewsCommentMutation,
  UpdateOwnNewsCommentMutationVariables
>

/**
 * __useUpdateOwnNewsCommentMutation__
 *
 * To run a mutation, you first call `useUpdateOwnNewsCommentMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateOwnNewsCommentMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateOwnNewsCommentMutation, { data, loading, error }] = useUpdateOwnNewsCommentMutation({
 *   variables: {
 *      id: // value for 'id'
 *      body: // value for 'body'
 *   },
 * });
 */
export function useUpdateOwnNewsCommentMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateOwnNewsCommentMutation,
    UpdateOwnNewsCommentMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateOwnNewsCommentMutation,
    UpdateOwnNewsCommentMutationVariables
  >(UpdateOwnNewsCommentDocument, baseOptions)
}
export type UpdateOwnNewsCommentMutationHookResult = ReturnType<
  typeof useUpdateOwnNewsCommentMutation
>
export type UpdateOwnNewsCommentMutationResult = Apollo.MutationResult<
  UpdateOwnNewsCommentMutation
>
export type UpdateOwnNewsCommentMutationOptions = Apollo.BaseMutationOptions<
  UpdateOwnNewsCommentMutation,
  UpdateOwnNewsCommentMutationVariables
>
export const UpdateOwnNoteDocument = gql`
  mutation UpdateOwnNote($id: String!, $paragraph: String!, $body: String!) {
...
`
export type UpdateOwnNoteMutationFn = Apollo.MutationFunction<
  UpdateOwnNoteMutation,
  UpdateOwnNoteMutationVariables
>

/**
 * __useUpdateOwnNoteMutation__
 *
 * To run a mutation, you first call `useUpdateOwnNoteMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateOwnNoteMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateOwnNoteMutation, { data, loading, error }] = useUpdateOwnNoteMutation({
 *   variables: {
 *      id: // value for 'id'
 *      paragraph: // value for 'paragraph'
 *      body: // value for 'body'
 ...
 * });
 */
export function useUpdateOwnNoteMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateOwnNoteMutation,
    UpdateOwnNoteMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateOwnNoteMutation,
    UpdateOwnNoteMutationVariables
  >(UpdateOwnNoteDocument, baseOptions)
}
export type UpdateOwnNoteMutationHookResult = ReturnType<
  typeof useUpdateOwnNoteMutation
>
export type UpdateOwnNoteMutationResult = Apollo.MutationResult<
  UpdateOwnNoteMutation
>
export type UpdateOwnNoteMutationOptions = Apollo.BaseMutationOptions<
  UpdateOwnNoteMutation,
  UpdateOwnNoteMutationVariables
>
export const UpdateOwnNoteCommentDocument = gql`
  mutation UpdateOwnNoteComment($id: String!, $body: String!) {
...
`
export type UpdateOwnNoteCommentMutationFn = Apollo.MutationFunction<
  UpdateOwnNoteCommentMutation,
  UpdateOwnNoteCommentMutationVariables
>

/**
 * __useUpdateOwnNoteCommentMutation__
 *
 * To run a mutation, you first call `useUpdateOwnNoteCommentMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateOwnNoteCommentMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateOwnNoteCommentMutation, { data, loading, error }] = useUpdateOwnNoteCommentMutation({
 *   variables: {
 *      id: // value for 'id'
 *      body: // value for 'body'
 *   },
 * });
 */
export function useUpdateOwnNoteCommentMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateOwnNoteCommentMutation,
    UpdateOwnNoteCommentMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateOwnNoteCommentMutation,
    UpdateOwnNoteCommentMutationVariables
  >(UpdateOwnNoteCommentDocument, baseOptions)
}
export type UpdateOwnNoteCommentMutationHookResult = ReturnType<
  typeof useUpdateOwnNoteCommentMutation
>
export type UpdateOwnNoteCommentMutationResult = Apollo.MutationResult<
  UpdateOwnNoteCommentMutation
>
export type UpdateOwnNoteCommentMutationOptions = Apollo.BaseMutationOptions<
  UpdateOwnNoteCommentMutation,
  UpdateOwnNoteCommentMutationVariables
>
...
`
export type UpdateReelMutationFn = Apollo.MutationFunction<
  UpdateReelMutation,
  UpdateReelMutationVariables
>
 ...
 *   variables: {
 *      reelDescription: // value for 'reelDescription'
 *      reel: // value for 'reel'
 *   },
 * });
 */
export function useUpdateReelMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateReelMutation,
    UpdateReelMutationVariables
  >
) {
  return Apollo.useMutation<UpdateReelMutation, UpdateReelMutationVariables>(
    UpdateReelDocument,
    baseOptions
  )
}
export type UpdateReelMutationHookResult = ReturnType<
  typeof useUpdateReelMutation
>
export type UpdateReelMutationResult = Apollo.MutationResult<UpdateReelMutation>
export type UpdateReelMutationOptions = Apollo.BaseMutationOptions<
  UpdateReelMutation,
  UpdateReelMutationVariables
>
export const UpdateOwnSubmissionCommentDocument = gql`
  mutation updateOwnSubmissionComment(
    $comment: String!
    $shortComment: String!
    $id: String!
  ) {
...
`
export type UpdateOwnSubmissionCommentMutationFn = Apollo.MutationFunction<
  UpdateOwnSubmissionCommentMutation,
  UpdateOwnSubmissionCommentMutationVariables
>

/**
 * __useUpdateOwnSubmissionCommentMutation__
 *
 * To run a mutation, you first call `useUpdateOwnSubmissionCommentMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateOwnSubmissionCommentMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateOwnSubmissionCommentMutation, { data, loading, error }] = useUpdateOwnSubmissionCommentMutation({
 *   variables: {
 *      comment: // value for 'comment'
 *      shortComment: // value for 'shortComment'
 *      id: // value for 'id'
 *   },
 * });
 */
export function useUpdateOwnSubmissionCommentMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateOwnSubmissionCommentMutation,
    UpdateOwnSubmissionCommentMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateOwnSubmissionCommentMutation,
    UpdateOwnSubmissionCommentMutationVariables
  >(UpdateOwnSubmissionCommentDocument, baseOptions)
}
export type UpdateOwnSubmissionCommentMutationHookResult = ReturnType<
  typeof useUpdateOwnSubmissionCommentMutation
>
export type UpdateOwnSubmissionCommentMutationResult = Apollo.MutationResult<
  UpdateOwnSubmissionCommentMutation
>
export type UpdateOwnSubmissionCommentMutationOptions = Apollo.BaseMutationOptions<
  UpdateOwnSubmissionCommentMutation,
  UpdateOwnSubmissionCommentMutationVariables
>
export const AcceptedAgreementDocument = gql`
  query acceptedAgreement {
    __typename
    currentProfile {
 ...
 *
 * To run a query within a React component, call `useAcceptedAgreementQuery` and pass it any options that fit your needs.
 * When your component renders, `useAcceptedAgreementQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAcceptedAgreementQuery({
 *   variables: {
 *   },
 * });
 */
export function useAcceptedAgreementQuery(
  ...
  return Apollo.useQuery<
    AcceptedAgreementQuery,
    AcceptedAgreementQueryVariables
  >(AcceptedAgreementDocument, baseOptions)
}
export function useAcceptedAgreementLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    AcceptedAgreementQuery,
    AcceptedAgreementQueryVariables
  >
...
export type AcceptedAgreementQueryHookResult = ReturnType<
  typeof useAcceptedAgreementQuery
>
export type AcceptedAgreementLazyQueryHookResult = ReturnType<
  typeof useAcceptedAgreementLazyQuery
>
export type AcceptedAgreementQueryResult = Apollo.QueryResult<
  AcceptedAgreementQuery,
  AcceptedAgreementQueryVariables
>
export const GetAllAdminInstructorsDocument = gql`
...
/**
 * __useGetAllAdminInstructorsQuery__
 *
 * To run a query within a React component, call `useGetAllAdminInstructorsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllAdminInstructorsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllAdminInstructorsQuery({
 *   variables: {
 ...
 * });
 */
export function useGetAllAdminInstructorsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetAllAdminInstructorsQuery,
    GetAllAdminInstructorsQueryVariables
  >
) {
  return Apollo.useQuery<
    GetAllAdminInstructorsQuery,
    GetAllAdminInstructorsQueryVariables
  >(GetAllAdminInstructorsDocument, baseOptions)
}
export function useGetAllAdminInstructorsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAllAdminInstructorsQuery,
    GetAllAdminInstructorsQueryVariables
  >
...
export type GetAllAdminInstructorsQueryHookResult = ReturnType<
  typeof useGetAllAdminInstructorsQuery
>
export type GetAllAdminInstructorsLazyQueryHookResult = ReturnType<
  typeof useGetAllAdminInstructorsLazyQuery
>
export type GetAllAdminInstructorsQueryResult = Apollo.QueryResult<
  GetAllAdminInstructorsQuery,
  GetAllAdminInstructorsQueryVariables
>
export const GetAllAnimationDocument = gql`
...
/**
 * __useGetAllAnimationQuery__
 *
 * To run a query within a React component, call `useGetAllAnimationQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllAnimationQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllAnimationQuery({
 *   variables: {
 *      offset: // value for 'offset'
 *   },
 * });
 */
export function useGetAllAnimationQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetAllAnimationQuery,
    GetAllAnimationQueryVariables
  >
) {
  return Apollo.useQuery<GetAllAnimationQuery, GetAllAnimationQueryVariables>(
    GetAllAnimationDocument,
    baseOptions
  )
}
export function useGetAllAnimationLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAllAnimationQuery,
    GetAllAnimationQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    GetAllAnimationQuery,
    GetAllAnimationQueryVariables
  >(GetAllAnimationDocument, baseOptions)
}
export type GetAllAnimationQueryHookResult = ReturnType<
  typeof useGetAllAnimationQuery
>
export type GetAllAnimationLazyQueryHookResult = ReturnType<
  typeof useGetAllAnimationLazyQuery
>
export type GetAllAnimationQueryResult = Apollo.QueryResult<
  GetAllAnimationQuery,
  GetAllAnimationQueryVariables
>
export const GetAllCompaniesDocument = gql`
  query getAllCompanies($first: Int!, $offset: Int!) {
    allCompanies(offset: $offset, first: $first, orderBy: NAME_ASC) {
      nodes {
        name
        nameUrlSafe
        link
...
export type GetAllCompaniesQueryResult = Apollo.QueryResult<
  ...
  GetAllCompaniesQueryVariables
>
export const GetAllCompanyAdminGroupsDocument = gql`
  query getAllCompanyAdminGroups($offset: Int!) {
...
/**
 * __useGetAllCompanyAdminGroupsQuery__
 *
 * To run a query within a React component, call `useGetAllCompanyAdminGroupsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllCompanyAdminGroupsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllCompanyAdminGroupsQuery({
 *   variables: {
 *      offset: // value for 'offset'
 *   },
 * });
 */
export function useGetAllCompanyAdminGroupsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetAllCompanyAdminGroupsQuery,
    GetAllCompanyAdminGroupsQueryVariables
  >
) {
  return Apollo.useQuery<
    GetAllCompanyAdminGroupsQuery,
    GetAllCompanyAdminGroupsQueryVariables
  >(GetAllCompanyAdminGroupsDocument, baseOptions)
}
export function useGetAllCompanyAdminGroupsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAllCompanyAdminGroupsQuery,
    GetAllCompanyAdminGroupsQueryVariables
  >
...
export type GetAllCompanyAdminGroupsQueryHookResult = ReturnType<
  typeof useGetAllCompanyAdminGroupsQuery
>
export type GetAllCompanyAdminGroupsLazyQueryHookResult = ReturnType<
  typeof useGetAllCompanyAdminGroupsLazyQuery
>
export type GetAllCompanyAdminGroupsQueryResult = Apollo.QueryResult<
  GetAllCompanyAdminGroupsQuery,
  GetAllCompanyAdminGroupsQueryVariables
>
export const GetAllCompanyAdminMembersDocument = gql`
  query getAllCompanyAdminMembers($offset: Int!) {
    allVCompanyAdminMembers(first: 50, offset: $offset) {
      nodes {
        username
        lastname
        groupName
...
/**
 * __useGetAllCompanyAdminMembersQuery__
 *
 * To run a query within a React component, call `useGetAllCompanyAdminMembersQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllCompanyAdminMembersQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllCompanyAdminMembersQuery({
 *   variables: {
 *      offset: // value for 'offset'
 *   },
 * });
 */
export function useGetAllCompanyAdminMembersQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetAllCompanyAdminMembersQuery,
    GetAllCompanyAdminMembersQueryVariables
  >
) {
  return Apollo.useQuery<
    GetAllCompanyAdminMembersQuery,
    GetAllCompanyAdminMembersQueryVariables
  >(GetAllCompanyAdminMembersDocument, baseOptions)
}
export function useGetAllCompanyAdminMembersLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAllCompanyAdminMembersQuery,
    GetAllCompanyAdminMembersQueryVariables
  >
...
export type GetAllCompanyAdminMembersQueryHookResult = ReturnType<
  typeof useGetAllCompanyAdminMembersQuery
>
export type GetAllCompanyAdminMembersLazyQueryHookResult = ReturnType<
  typeof useGetAllCompanyAdminMembersLazyQuery
>
export type GetAllCompanyAdminMembersQueryResult = Apollo.QueryResult<
  GetAllCompanyAdminMembersQuery,
  GetAllCompanyAdminMembersQueryVariables
>
export const GetAllFeedbackDocument = gql`
  query getAllFeedback($offset: Int!) {
...
/**
 * __useGetAllFeedbackQuery__
 *
 * To run a query within a React component, call `useGetAllFeedbackQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllFeedbackQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllFeedbackQuery({
 *   variables: {
 *      offset: // value for 'offset'
 *   },
 * });
 */
export function useGetAllFeedbackQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetAllFeedbackQuery,
    GetAllFeedbackQueryVariables
  >
) {
  return Apollo.useQuery<GetAllFeedbackQuery, GetAllFeedbackQueryVariables>(
    GetAllFeedbackDocument,
    baseOptions
  )
}
export function useGetAllFeedbackLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAllFeedbackQuery,
    GetAllFeedbackQueryVariables
  >
) {
  return Apollo.useLazyQuery<GetAllFeedbackQuery, GetAllFeedbackQueryVariables>(
    GetAllFeedbackDocument,
    baseOptions
  )
}
export type GetAllFeedbackQueryHookResult = ReturnType<
  typeof useGetAllFeedbackQuery
>
export type GetAllFeedbackLazyQueryHookResult = ReturnType<
  typeof useGetAllFeedbackLazyQuery
>
export type GetAllFeedbackQueryResult = Apollo.QueryResult<
  GetAllFeedbackQuery,
  GetAllFeedbackQueryVariables
>
export const GetAllHeadlinesDocument = gql`
...
/**
 * __useGetAllHeadlinesQuery__
 *
 * To run a query within a React component, call `useGetAllHeadlinesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllHeadlinesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllHeadlinesQuery({
 *   variables: {
 *      offset: // value for 'offset'
 *   },
 * });
 */
export function useGetAllHeadlinesQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetAllHeadlinesQuery,
    GetAllHeadlinesQueryVariables
  >
) {
  return Apollo.useQuery<GetAllHeadlinesQuery, GetAllHeadlinesQueryVariables>(
    GetAllHeadlinesDocument,
    baseOptions
  )
}
export function useGetAllHeadlinesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAllHeadlinesQuery,
    GetAllHeadlinesQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    GetAllHeadlinesQuery,
    GetAllHeadlinesQueryVariables
  >(GetAllHeadlinesDocument, baseOptions)
}
export type GetAllHeadlinesQueryHookResult = ReturnType<
  typeof useGetAllHeadlinesQuery
>
export type GetAllHeadlinesLazyQueryHookResult = ReturnType<
  typeof useGetAllHeadlinesLazyQuery
>
export type GetAllHeadlinesQueryResult = Apollo.QueryResult<
  GetAllHeadlinesQuery,
  GetAllHeadlinesQueryVariables
>
export const GetAllInstructorsDocument = gql`
  query getAllInstructors {
    allInstructors(filter: { status: { equalTo: ACTIVE } }) {
      nodes {
        banner
        profileByProfileId {
          about
...
export function useGetAllInstructorsQuery(
  ...
  return Apollo.useQuery<
    GetAllInstructorsQuery,
    GetAllInstructorsQueryVariables
  >(GetAllInstructorsDocument, baseOptions)
}
...
export function useGetAllNewsQuery(
  ...
  return Apollo.useQuery<GetAllNewsQuery, GetAllNewsQueryVariables>(
    GetAllNewsDocument,
    baseOptions
  )
}
export function useGetAllNewsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAllNewsQuery,
    GetAllNewsQueryVariables
  >
) {
  return Apollo.useLazyQuery<GetAllNewsQuery, GetAllNewsQueryVariables>(
    GetAllNewsDocument,
    baseOptions
  )
}
export type GetAllNewsQueryHookResult = ReturnType<typeof useGetAllNewsQuery>
export type GetAllNewsLazyQueryHookResult = ReturnType<
  typeof useGetAllNewsLazyQuery
>
export type GetAllNewsQueryResult = Apollo.QueryResult<
  GetAllNewsQuery,
  GetAllNewsQueryVariables
>
export const GetAllNoteCommentsDocument = gql`
...
/**
 * __useGetAllNoteCommentsQuery__
 *
 * To run a query within a React component, call `useGetAllNoteCommentsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllNoteCommentsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllNoteCommentsQuery({
 *   variables: {
 *      noteId: // value for 'noteId'
 *      offset: // value for 'offset'
 *   },
 * });
 */
export function useGetAllNoteCommentsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetAllNoteCommentsQuery,
    GetAllNoteCommentsQueryVariables
  >
) {
  return Apollo.useQuery<
    GetAllNoteCommentsQuery,
    GetAllNoteCommentsQueryVariables
  >(GetAllNoteCommentsDocument, baseOptions)
}
export function useGetAllNoteCommentsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAllNoteCommentsQuery,
    GetAllNoteCommentsQueryVariables
  >
...
export type GetAllNoteCommentsQueryHookResult = ReturnType<
  typeof useGetAllNoteCommentsQuery
>
export type GetAllNoteCommentsLazyQueryHookResult = ReturnType<
  typeof useGetAllNoteCommentsLazyQuery
>
export type GetAllNoteCommentsQueryResult = Apollo.QueryResult<
  GetAllNoteCommentsQuery,
  GetAllNoteCommentsQueryVariables
>
...
export function useGetAllNotesQuery(
  ...
  return Apollo.useQuery<GetAllNotesQuery, GetAllNotesQueryVariables>(
    GetAllNotesDocument,
    baseOptions
  )
}
export function useGetAllNotesLazyQuery(
  ...
  return Apollo.useLazyQuery<GetAllNotesQuery, GetAllNotesQueryVariables>(
    GetAllNotesDocument,
    baseOptions
  )
}
export type GetAllNotesQueryHookResult = ReturnType<typeof useGetAllNotesQuery>
export type GetAllNotesLazyQueryHookResult = ReturnType<
  typeof useGetAllNotesLazyQuery
>
export type GetAllNotesQueryResult = Apollo.QueryResult<
  GetAllNotesQuery,
  GetAllNotesQueryVariables
>
export const GetAllOwnProFeedbackDocument = gql`
  query getAllOwnProFeedback {
    allVProOwnFeedbacks(orderBy: CREATED_AT_DESC) {
      nodes {
        id
        animationId
        avatar
...
/**
 * __useGetAllOwnProFeedbackQuery__
 *
 * To run a query within a React component, call `useGetAllOwnProFeedbackQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllOwnProFeedbackQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllOwnProFeedbackQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetAllOwnProFeedbackQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetAllOwnProFeedbackQuery,
    GetAllOwnProFeedbackQueryVariables
  >
) {
  return Apollo.useQuery<
    GetAllOwnProFeedbackQuery,
    GetAllOwnProFeedbackQueryVariables
  >(GetAllOwnProFeedbackDocument, baseOptions)
}
export function useGetAllOwnProFeedbackLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAllOwnProFeedbackQuery,
    GetAllOwnProFeedbackQueryVariables
  >
...
export type GetAllOwnProFeedbackQueryHookResult = ReturnType<
  typeof useGetAllOwnProFeedbackQuery
>
export type GetAllOwnProFeedbackLazyQueryHookResult = ReturnType<
  typeof useGetAllOwnProFeedbackLazyQuery
>
export type GetAllOwnProFeedbackQueryResult = Apollo.QueryResult<
  GetAllOwnProFeedbackQuery,
  GetAllOwnProFeedbackQueryVariables
>
export const GetAllPoolDocument = gql`
...
/**
 * __useGetAllPoolQuery__
 *
 * To run a query within a React component, call `useGetAllPoolQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllPoolQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllPoolQuery({
 *   variables: {
 *      offset: // value for 'offset'
 *   },
 * });
 */
export function useGetAllPoolQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetAllPoolQuery,
    GetAllPoolQueryVariables
  >
) {
  return Apollo.useQuery<GetAllPoolQuery, GetAllPoolQueryVariables>(
    GetAllPoolDocument,
    baseOptions
  )
}
export function useGetAllPoolLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAllPoolQuery,
    GetAllPoolQueryVariables
  >
) {
  return Apollo.useLazyQuery<GetAllPoolQuery, GetAllPoolQueryVariables>(
    GetAllPoolDocument,
    baseOptions
  )
}
export type GetAllPoolQueryHookResult = ReturnType<typeof useGetAllPoolQuery>
export type GetAllPoolLazyQueryHookResult = ReturnType<
  typeof useGetAllPoolLazyQuery
>
export type GetAllPoolQueryResult = Apollo.QueryResult<
  GetAllPoolQuery,
  GetAllPoolQueryVariables
>
...
export function useGetAllPostCommentsQuery(
  ...
  return Apollo.useQuery<
    GetAllPostCommentsQuery,
    GetAllPostCommentsQueryVariables
  >(GetAllPostCommentsDocument, baseOptions)
}
...
export type GetAllPostCommentsQueryResult = Apollo.QueryResult<
  ...
  GetAllPostCommentsQueryVariables
>
export const GetAllSubmissionsDocument = gql`
...
/**
 * __useGetAllSubmissionsQuery__
 *
 * To run a query within a React component, call `useGetAllSubmissionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllSubmissionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllSubmissionsQuery({
 *   variables: {
 *      animationId: // value for 'animationId'
 *   },
 * });
 */
export function useGetAllSubmissionsQuery(
  baseOptions: Apollo.QueryHookOptions<
  ...
  return Apollo.useQuery<
    GetAllSubmissionsQuery,
    GetAllSubmissionsQueryVariables
  >(GetAllSubmissionsDocument, baseOptions)
}
export function useGetAllSubmissionsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAllSubmissionsQuery,
    GetAllSubmissionsQueryVariables
  >
...
export type GetAllSubmissionsQueryHookResult = ReturnType<
  typeof useGetAllSubmissionsQuery
>
export type GetAllSubmissionsLazyQueryHookResult = ReturnType<
  typeof useGetAllSubmissionsLazyQuery
>
export type GetAllSubmissionsQueryResult = Apollo.QueryResult<
  GetAllSubmissionsQuery,
  GetAllSubmissionsQueryVariables
>
export const GetAllVInstructorSettingsDocument = gql`
  query getAllVInstructorSettings {
    allVInstructorSettings {
      nodes {
        updatedAt
        status
        id
...
/**
 * __useGetAllVInstructorSettingsQuery__
 *
 * To run a query within a React component, call `useGetAllVInstructorSettingsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllVInstructorSettingsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllVInstructorSettingsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetAllVInstructorSettingsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetAllVInstructorSettingsQuery,
    GetAllVInstructorSettingsQueryVariables
  >
) {
  return Apollo.useQuery<
    GetAllVInstructorSettingsQuery,
    GetAllVInstructorSettingsQueryVariables
  >(GetAllVInstructorSettingsDocument, baseOptions)
}
export function useGetAllVInstructorSettingsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAllVInstructorSettingsQuery,
    GetAllVInstructorSettingsQueryVariables
  >
...
export type GetAllVInstructorSettingsQueryHookResult = ReturnType<
  typeof useGetAllVInstructorSettingsQuery
>
export type GetAllVInstructorSettingsLazyQueryHookResult = ReturnType<
  typeof useGetAllVInstructorSettingsLazyQuery
>
export type GetAllVInstructorSettingsQueryResult = Apollo.QueryResult<
  GetAllVInstructorSettingsQuery,
  GetAllVInstructorSettingsQueryVariables
>
export const GetAnimationDocument = gql`
  query getAnimation($animationId: String!, $submissionId: String!) {
    allVAnimations(
 ...
 * });
 */
export function useGetAnimationQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetAnimationQuery,
    GetAnimationQueryVariables
  >
) {
  return Apollo.useQuery<GetAnimationQuery, GetAnimationQueryVariables>(
    GetAnimationDocument,
    baseOptions
  )
}
export function useGetAnimationLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAnimationQuery,
    GetAnimationQueryVariables
  >
) {
  return Apollo.useLazyQuery<GetAnimationQuery, GetAnimationQueryVariables>(
    GetAnimationDocument,
    baseOptions
  )
}
export type GetAnimationQueryHookResult = ReturnType<
  typeof useGetAnimationQuery
>
export type GetAnimationLazyQueryHookResult = ReturnType<
  typeof useGetAnimationLazyQuery
>
export type GetAnimationQueryResult = Apollo.QueryResult<
  GetAnimationQuery,
  GetAnimationQueryVariables
>
export const GetClaimedPendingFeedbackDocument = gql`
...
/**
 * __useGetClaimedPendingFeedbackQuery__
 *
 * To run a query within a React component, call `useGetClaimedPendingFeedbackQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetClaimedPendingFeedbackQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetClaimedPendingFeedbackQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetClaimedPendingFeedbackQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetClaimedPendingFeedbackQuery,
    GetClaimedPendingFeedbackQueryVariables
  >
) {
  return Apollo.useQuery<
    GetClaimedPendingFeedbackQuery,
    GetClaimedPendingFeedbackQueryVariables
  >(GetClaimedPendingFeedbackDocument, baseOptions)
}
export function useGetClaimedPendingFeedbackLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetClaimedPendingFeedbackQuery,
    GetClaimedPendingFeedbackQueryVariables
  >
...
export type GetClaimedPendingFeedbackQueryHookResult = ReturnType<
  typeof useGetClaimedPendingFeedbackQuery
>
export type GetClaimedPendingFeedbackLazyQueryHookResult = ReturnType<
  typeof useGetClaimedPendingFeedbackLazyQuery
>
export type GetClaimedPendingFeedbackQueryResult = Apollo.QueryResult<
  GetClaimedPendingFeedbackQuery,
  GetClaimedPendingFeedbackQueryVariables
>
export const GetCompanyAdminMembersDocument = gql`
...
/**
 * __useGetCompanyAdminMembersQuery__
 *
 * To run a query within a React component, call `useGetCompanyAdminMembersQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetCompanyAdminMembersQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetCompanyAdminMembersQuery({
 *   variables: {
 *      offset: // value for 'offset'
 *      groupId: // value for 'groupId'
 *   },
 * });
 */
export function useGetCompanyAdminMembersQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetCompanyAdminMembersQuery,
    GetCompanyAdminMembersQueryVariables
  >
) {
  return Apollo.useQuery<
    GetCompanyAdminMembersQuery,
    GetCompanyAdminMembersQueryVariables
  >(GetCompanyAdminMembersDocument, baseOptions)
}
export function useGetCompanyAdminMembersLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetCompanyAdminMembersQuery,
    GetCompanyAdminMembersQueryVariables
  >
...
export type GetCompanyAdminMembersQueryHookResult = ReturnType<
  typeof useGetCompanyAdminMembersQuery
>
export type GetCompanyAdminMembersLazyQueryHookResult = ReturnType<
  typeof useGetCompanyAdminMembersLazyQuery
>
export type GetCompanyAdminMembersQueryResult = Apollo.QueryResult<
  GetCompanyAdminMembersQuery,
  GetCompanyAdminMembersQueryVariables
>
export const GetCompanyAdminPageDocument = gql`
...
/**
 * __useGetCompanyAdminPageQuery__
 *
 * To run a query within a React component, call `useGetCompanyAdminPageQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetCompanyAdminPageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetCompanyAdminPageQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetCompanyAdminPageQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetCompanyAdminPageQuery,
    GetCompanyAdminPageQueryVariables
  >
) {
  return Apollo.useQuery<
    GetCompanyAdminPageQuery,
    GetCompanyAdminPageQueryVariables
  >(GetCompanyAdminPageDocument, baseOptions)
}
export function useGetCompanyAdminPageLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetCompanyAdminPageQuery,
    GetCompanyAdminPageQueryVariables
  >
...
export type GetCompanyAdminPageQueryHookResult = ReturnType<
  typeof useGetCompanyAdminPageQuery
>
export type GetCompanyAdminPageLazyQueryHookResult = ReturnType<
  typeof useGetCompanyAdminPageLazyQuery
>
export type GetCompanyAdminPageQueryResult = Apollo.QueryResult<
  GetCompanyAdminPageQuery,
  GetCompanyAdminPageQueryVariables
>
...
export function useGetCurrentProfileQuery(
  ...
  return Apollo.useQuery<
    GetCurrentProfileQuery,
    GetCurrentProfileQueryVariables
  >(GetCurrentProfileDocument, baseOptions)
}
...
export type GetCurrentProfileQueryHookResult = ReturnType<
  typeof useGetCurrentProfileQuery
>
export type GetCurrentProfileLazyQueryHookResult = ReturnType<
  typeof useGetCurrentProfileLazyQuery
>
export type GetCurrentProfileQueryResult = Apollo.QueryResult<
  GetCurrentProfileQuery,
  GetCurrentProfileQueryVariables
>
...
export type GetFeedbackQueryResult = Apollo.QueryResult<
  ...
  GetFeedbackQueryVariables
>
export const GetFeedbackMonthlyDetailsDocument = gql`
  query getFeedbackMonthlyDetails(
    $month: Int!
    $year: Int!
    $profileId: UUID!
  ) {
...
/**
 * __useGetFeedbackMonthlyDetailsQuery__
 *
 * To run a query within a React component, call `useGetFeedbackMonthlyDetailsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetFeedbackMonthlyDetailsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetFeedbackMonthlyDetailsQuery({
 *   variables: {
 *      month: // value for 'month'
 *      year: // value for 'year'
 *      profileId: // value for 'profileId'
 ...
 * });
 */
export function useGetFeedbackMonthlyDetailsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetFeedbackMonthlyDetailsQuery,
    GetFeedbackMonthlyDetailsQueryVariables
  >
) {
  return Apollo.useQuery<
    GetFeedbackMonthlyDetailsQuery,
    GetFeedbackMonthlyDetailsQueryVariables
  >(GetFeedbackMonthlyDetailsDocument, baseOptions)
}
export function useGetFeedbackMonthlyDetailsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetFeedbackMonthlyDetailsQuery,
    GetFeedbackMonthlyDetailsQueryVariables
  >
...
export type GetFeedbackMonthlyDetailsQueryHookResult = ReturnType<
  typeof useGetFeedbackMonthlyDetailsQuery
>
export type GetFeedbackMonthlyDetailsLazyQueryHookResult = ReturnType<
  typeof useGetFeedbackMonthlyDetailsLazyQuery
>
export type GetFeedbackMonthlyDetailsQueryResult = Apollo.QueryResult<
  GetFeedbackMonthlyDetailsQuery,
  GetFeedbackMonthlyDetailsQueryVariables
>
export const GetFeedbackMonthlyOverviewDocument = gql`
...
/**
 * __useGetFeedbackMonthlyOverviewQuery__
 *
 * To run a query within a React component, call `useGetFeedbackMonthlyOverviewQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetFeedbackMonthlyOverviewQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetFeedbackMonthlyOverviewQuery({
 *   variables: {
 *      year: // value for 'year'
 *      month: // value for 'month'
 *      offset: // value for 'offset'
 ...
 * });
 */
export function useGetFeedbackMonthlyOverviewQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetFeedbackMonthlyOverviewQuery,
    GetFeedbackMonthlyOverviewQueryVariables
  >
) {
  return Apollo.useQuery<
    GetFeedbackMonthlyOverviewQuery,
    GetFeedbackMonthlyOverviewQueryVariables
  >(GetFeedbackMonthlyOverviewDocument, baseOptions)
}
export function useGetFeedbackMonthlyOverviewLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetFeedbackMonthlyOverviewQuery,
    GetFeedbackMonthlyOverviewQueryVariables
  >
...
export type GetFeedbackMonthlyOverviewQueryHookResult = ReturnType<
  typeof useGetFeedbackMonthlyOverviewQuery
>
export type GetFeedbackMonthlyOverviewLazyQueryHookResult = ReturnType<
  typeof useGetFeedbackMonthlyOverviewLazyQuery
>
export type GetFeedbackMonthlyOverviewQueryResult = Apollo.QueryResult<
  GetFeedbackMonthlyOverviewQuery,
  GetFeedbackMonthlyOverviewQueryVariables
>
export const GetFrontpageHeadlinesDocument = gql`
  query getFrontpageHeadlines {
...
/**
 * __useGetFrontpageHeadlinesQuery__
 *
 * To run a query within a React component, call `useGetFrontpageHeadlinesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetFrontpageHeadlinesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetFrontpageHeadlinesQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetFrontpageHeadlinesQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetFrontpageHeadlinesQuery,
    GetFrontpageHeadlinesQueryVariables
  >
) {
  return Apollo.useQuery<
    GetFrontpageHeadlinesQuery,
    GetFrontpageHeadlinesQueryVariables
  >(GetFrontpageHeadlinesDocument, baseOptions)
}
export function useGetFrontpageHeadlinesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetFrontpageHeadlinesQuery,
    GetFrontpageHeadlinesQueryVariables
  >
...
export type GetFrontpageHeadlinesQueryHookResult = ReturnType<
  typeof useGetFrontpageHeadlinesQuery
>
export type GetFrontpageHeadlinesLazyQueryHookResult = ReturnType<
  typeof useGetFrontpageHeadlinesLazyQuery
>
export type GetFrontpageHeadlinesQueryResult = Apollo.QueryResult<
  GetFrontpageHeadlinesQuery,
  GetFrontpageHeadlinesQueryVariables
>
 ...
 * });
 */
export function useGetFullProfileQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetFullProfileQuery,
    GetFullProfileQueryVariables
  >
) {
  return Apollo.useQuery<GetFullProfileQuery, GetFullProfileQueryVariables>(
    GetFullProfileDocument,
    baseOptions
  )
}
export function useGetFullProfileLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetFullProfileQuery,
    GetFullProfileQueryVariables
  >
) {
  return Apollo.useLazyQuery<GetFullProfileQuery, GetFullProfileQueryVariables>(
    GetFullProfileDocument,
    baseOptions
  )
}
export type GetFullProfileQueryHookResult = ReturnType<
  typeof useGetFullProfileQuery
>
export type GetFullProfileLazyQueryHookResult = ReturnType<
  typeof useGetFullProfileLazyQuery
>
export type GetFullProfileQueryResult = Apollo.QueryResult<
  GetFullProfileQuery,
  GetFullProfileQueryVariables
>
export const GetOwnNoteDocument = gql`
...
/**
 * __useGetOwnNoteQuery__
 *
 * To run a query within a React component, call `useGetOwnNoteQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetOwnNoteQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetOwnNoteQuery({
 *   variables: {
 *      submissionId: // value for 'submissionId'
 *   },
 * });
 */
export function useGetOwnNoteQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetOwnNoteQuery,
    GetOwnNoteQueryVariables
  >
) {
  return Apollo.useQuery<GetOwnNoteQuery, GetOwnNoteQueryVariables>(
    GetOwnNoteDocument,
    baseOptions
  )
}
export function useGetOwnNoteLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetOwnNoteQuery,
    GetOwnNoteQueryVariables
  >
) {
  return Apollo.useLazyQuery<GetOwnNoteQuery, GetOwnNoteQueryVariables>(
    GetOwnNoteDocument,
    baseOptions
  )
}
export type GetOwnNoteQueryHookResult = ReturnType<typeof useGetOwnNoteQuery>
export type GetOwnNoteLazyQueryHookResult = ReturnType<
  typeof useGetOwnNoteLazyQuery
>
export type GetOwnNoteQueryResult = Apollo.QueryResult<
  GetOwnNoteQuery,
  GetOwnNoteQueryVariables
>
export const GetPostBySlugDocument = gql`
  query getPostBySlug($slug: String!) {
    getPostBySlug(slug_: $slug) {
      createdAt
      updatedAt
      body
      id
...
export type GetPostBySlugQueryResult = Apollo.QueryResult<
  ...
  GetPostBySlugQueryVariables
>
export const GetProViewDocument = gql`
  query getProView {
    allVProMemberships {
      nodes {
        username
...
/**
 * __useGetProViewQuery__
 *
 * To run a query within a React component, call `useGetProViewQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetProViewQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetProViewQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetProViewQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetProViewQuery,
    GetProViewQueryVariables
  >
) {
  return Apollo.useQuery<GetProViewQuery, GetProViewQueryVariables>(
    GetProViewDocument,
    baseOptions
  )
}
export function useGetProViewLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetProViewQuery,
    GetProViewQueryVariables
  >
) {
  return Apollo.useLazyQuery<GetProViewQuery, GetProViewQueryVariables>(
    GetProViewDocument,
    baseOptions
  )
}
export type GetProViewQueryHookResult = ReturnType<typeof useGetProViewQuery>
export type GetProViewLazyQueryHookResult = ReturnType<
  typeof useGetProViewLazyQuery
>
export type GetProViewQueryResult = Apollo.QueryResult<
  GetProViewQuery,
  GetProViewQueryVariables
>
...
>
export const IsRegistrationOpenDocument = gql`
  query isRegistrationOpen {
    isRegistrationOpen
  }
`

/**
 * __useIsRegistrationOpenQuery__
 *
 * To run a query within a React component, call `useIsRegistrationOpenQuery` and pass it any options that fit your needs.
 * When your component renders, `useIsRegistrationOpenQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useIsRegistrationOpenQuery({
 *   variables: {
 *   },
 * });
 */
export function useIsRegistrationOpenQuery(
  baseOptions?: Apollo.QueryHookOptions<
    IsRegistrationOpenQuery,
    IsRegistrationOpenQueryVariables
  >
) {
  return Apollo.useQuery<
    IsRegistrationOpenQuery,
    IsRegistrationOpenQueryVariables
  >(IsRegistrationOpenDocument, baseOptions)
}
export function useIsRegistrationOpenLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    IsRegistrationOpenQuery,
    IsRegistrationOpenQueryVariables
  >
...
export type IsRegistrationOpenQueryHookResult = ReturnType<
  typeof useIsRegistrationOpenQuery
>
export type IsRegistrationOpenLazyQueryHookResult = ReturnType<
  typeof useIsRegistrationOpenLazyQuery
>
export type IsRegistrationOpenQueryResult = Apollo.QueryResult<
  IsRegistrationOpenQuery,
  IsRegistrationOpenQueryVariables
>
